...
[train, test] = np.array_split(text, 2)
CountVec = CountVectorizer(ngram_range=(1, 1), stop_words='english')
Count_data = CountVec.fit_transform(train)
cv_df = pd.DataFrame(Count_data.toarray(), columns=CountVec.get_feature_names_out())
...
tf_idf_data = tf_idf_vec.fit_transform(train)
...
if __name__ == "__main__":
    cli_main()
detoxify/train.py at master · unitaryai/detoxify
